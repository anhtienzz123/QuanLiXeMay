...
public class HoaDonConstant {
	...
	// Phaan trang
	public static final String TIM_KIEM_THEO_MA_HOA_DON = "SELECT HoaDon.*, NhanVienHanhChinh.hoTenNV, KhachHang.hoTenKH , KhachHang.soDienThoai , ROW_NUMBER() OVER (ORDER BY maHoaDon) \r\n"
			+ "as row FROM HoaDon\r\n"
	...
	public static final String TIM_KIEM_THEO_MA_NHAN_VIEN = "SELECT HoaDon.*, NhanVienHanhChinh.hoTenNV, KhachHang.hoTenKH , KhachHang.soDienThoai , ROW_NUMBER() OVER (ORDER BY maHoaDon) \r\n"
			+ "as row FROM HoaDon\r\n"
			+ "inner join NhanVienHanhChinh on HoaDon.maNVHanhChinh = NhanVienHanhChinh.maNVHanhChinh\r\n"
			+ "inner join KhachHang on HoaDon.maKhachHang = KhachHang.maKhachHang\r\n"
			+ "where HoaDon.maNVHanhChinh like ?";

	public static final String TIM_KIEM_THEO_TEN_NHAN_VIEN = "SELECT HoaDon.*, NhanVienHanhChinh.hoTenNV, KhachHang.hoTenKH , KhachHang.soDienThoai , ROW_NUMBER() OVER (ORDER BY maHoaDon) \r\n"
			+ "as row FROM HoaDon\r\n"
			+ "inner join NhanVienHanhChinh on HoaDon.maNVHanhChinh = NhanVienHanhChinh.maNVHanhChinh\r\n"
			+ "inner join KhachHang on HoaDon.maKhachHang = KhachHang.maKhachHang\r\n" + "where hoTenNV like ?";

	public static final String TIM_KIEM_THEO_MA_KHACH_HANG = "SELECT HoaDon.*, NhanVienHanhChinh.hoTenNV, KhachHang.hoTenKH , KhachHang.soDienThoai , ROW_NUMBER() OVER (ORDER BY maHoaDon) \r\n"
			+ "as row FROM HoaDon\r\n"
			+ "inner join NhanVienHanhChinh on HoaDon.maNVHanhChinh = NhanVienHanhChinh.maNVHanhChinh\r\n"
			+ "inner join KhachHang on HoaDon.maKhachHang = KhachHang.maKhachHang\r\n"
			+ "where HoaDon.maKhachHang like ?";

	public static final String TIM_KIEM_THEO_TEN_KHACH_HANG = "SELECT HoaDon.*, NhanVienHanhChinh.hoTenNV, KhachHang.hoTenKH , KhachHang.soDienThoai , ROW_NUMBER() OVER (ORDER BY maHoaDon) \r\n"
			+ "as row FROM HoaDon\r\n"
			+ "inner join NhanVienHanhChinh on HoaDon.maNVHanhChinh = NhanVienHanhChinh.maNVHanhChinh\r\n"
			+ "inner join KhachHang on HoaDon.maKhachHang = KhachHang.maKhachHang\r\n" + "where hoTenKH like ?";

	public static final String TIM_KIEM_THEO_SO_DIEN_THOAI = "SELECT HoaDon.*, NhanVienHanhChinh.hoTenNV, KhachHang.hoTenKH , KhachHang.soDienThoai , ROW_NUMBER() OVER (ORDER BY maHoaDon) \r\n"
			+ "as row FROM HoaDon\r\n"
			+ "inner join NhanVienHanhChinh on HoaDon.maNVHanhChinh = NhanVienHanhChinh.maNVHanhChinh\r\n"
