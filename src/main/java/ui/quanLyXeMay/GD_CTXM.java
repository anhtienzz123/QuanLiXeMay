...
public class GD_CTXM extends JFrame implements ActionListener {
	...
	public GD_CTXM() {
		...
		pnlIMG.setBackground(Color.LIGHT_GRAY);
		...
		lblHang.setPreferredSize(new Dimension(175, 40));
		...
		lblPhanKhoi.setForeground(Color.BLACK);
		...
		lblGia.setPreferredSize(new Dimension(150, 16));
		lblGia.setForeground(Color.BLACK);
		lblGia.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		lblNewLabel_1_1_1_2_1_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_1_1_1_2_1_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		lblNewLabel_1_1_1_2_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_1_1_1_2_1_1_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		...
		lblHeSo.setForeground(Color.BLACK);
		...
		lblSoKhung_1.setForeground(Color.BLACK);
		lblSoKhung_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		horizontalBox_5.add(lblSoKhung_1);
		
		Component rigidArea_12 = Box.createRigidArea(new Dimension(20, 20));
		rigidArea_12.setPreferredSize(new Dimension(40, 20));
		...
		lblSoSuon_1.setForeground(Color.BLACK);
		lblSoSuon_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
