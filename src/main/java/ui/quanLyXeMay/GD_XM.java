...
public class GD_XM extends JPanel implements ActionListener{
	...
	public GD_XM() {
		...
		btnDau = new JButton("");
		btnDau.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_fast_rewind_white_24dp.png")));
		...
		btnTruoc.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_skip_previous_white_24dp.png")));
		...
		btnSau = new JButton("");
		btnSau.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_skip_next_white_24dp.png")));
		...
		btnCuoi = new JButton("");
		btnCuoi.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_fast_forward_white_24dp.png")));
		...
		btnXemChiTiet.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_error_outline_white_18dp.png")));
		...
		btnXoa.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_delete_sweep_white_18dp.png")));
		...
		btnCapNhat.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_construction_white_18dp.png")));
		...
		btnThem.setIcon(new ImageIcon(GD_XM.class.getResource("/img/baseline_create_new_folder_white_18dp.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnThem)) {
			chuyenManHinh(new GD_TX());
		}else if (o.equals(btnCapNhat)) {
			chuyenManHinh(new GD_CNX());
