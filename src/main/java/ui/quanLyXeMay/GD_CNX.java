...
public class GD_CNX extends JPanel implements ActionListener {
	...
	public GD_CNX() {
		...
		JLabel lblX = new JLabel("Xuất xứ");
		lblX.setMaximumSize(new Dimension(100, 40));
		lblX.setPreferredSize(new Dimension(90, 40));
		lblX.setFont(new Font("Tahoma", Font.BOLD, 20));
		horizontalBox_2.add(lblX);
