...
public class GD_TNV extends JPanel implements ActionListener {
	...
	public GD_TNV() {
		...
		btnXoaRong.setIcon(new ImageIcon(GD_TNV.class.getResource("/img/baseline_delete_sweep_white_18dp.png")));
		...
		btnThem.setIcon(
				new ImageIcon(GD_TNV.class.getResource("/img/baseline_create_new_folder_white_18dp.png")));
