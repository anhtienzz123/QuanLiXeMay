...
//		lblAnh.setIcon(new ImageIcon(new ImageIcon("Img\\").getImage()
//				.getScaledInstance(pnlAnh.getWidth(), pnlAnh.getHeight(), Image.SCALE_DEFAULT)));
		...
		lblTenNV.setText("Nguyễn Trần Nhật Hào");
		...
		lblNgaySinh.setText("20-20-2020");
		...
		lblChucVu.setText("Quản lý nhân viên");
		...
		JLabel lblDiaChi = new JLabel("123456789012");
