...
public class GD_NhanVien extends JPanel implements ActionListener{
	...
	public GD_NhanVien() {
		...
		btnXemChiTiet.setIcon(new ImageIcon(GD_NhanVien.class.getResource("/img/baseline_error_outline_white_18dp.png")));
		...
		btnXoa.setIcon(new ImageIcon(GD_NhanVien.class.getResource("/img/baseline_delete_sweep_white_18dp.png")));
		...
		btnCapNhat.setIcon(new ImageIcon(GD_NhanVien.class.getResource("/img/baseline_construction_white_18dp.png")));
