...
public class GD_ChiTietBaoHanh extends JPanel implements ActionListener {
	...
	public GD_ChiTietBaoHanh() {
		...
		JLabel lblNewLabel_1_2_1 = new JLabel("Nguyễn Trần Nhật Hào");
		lblNewLabel_1_2_1.setPreferredSize(new Dimension(250, 40));
		lblNewLabel_1_2_1.setMaximumSize(new Dimension(250, 40));
		lblNewLabel_1_2_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		horizontalBox_2.add(lblNewLabel_1_2_1);
